...
export const ProductSlider=()=>{
  ...
  return (
    ...
    style={{backgroundImage: 'url(images/product-bg.png)',backgroundSize:"contain"}}
    ...
    className="h-[80vh] mb-5 bg-[] "
    speed={1000}
    loopPreventsSliding={true}
  >
    {
      Data&&Data.map((item,index)=>(
        <SwiperSlide className=" h-full w-full bg-[#e6c4c4] border" key={index}  >
