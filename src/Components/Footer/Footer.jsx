          ...
          <div className=" col-lg-3 col-md-6 col-sm-12">
            ...
            <div className="flex gap-1">
              ...
              <div className="m-[0rem] flex flex-col">
                <a
                  className="m-[0rem] flex flex-col text-white text-decoration-none"
                  href="tel:9724743444"
                >
                  +91 9724743444
                </a>
            ...
            <div className="flex mt-3 gap-2 ">
              ...
              ></i>
              <a
                className="justify-center mt-1 text-white items-center text-decoration-none"
